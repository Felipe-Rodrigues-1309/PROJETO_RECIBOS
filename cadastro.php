...
/* Fundo original */
body {
  background-image: linear-gradient(to left bottom, #000000, #0d730d);
  margin: 0;
  padding: 0;
  height: 100vh;
  display: flex;
...
<div class="card-glass">
    ...
    <!-- Ícone -->
    <div class="lock-icon"><img src="img/cadastro.png" alt="" width="90px"></div>

    <h2 class="text-white mb-3">Cadastro</h2>

<form action="back_end/cadastro.php" method="post">

        <div class="mb-3">
            <input name="usuario" type="text" class="form-control form-control-lg" placeholder="nome" required>
        </div>

                <div class="mb-3">
            <input name="email" type="email" class="form-control form-control-lg" placeholder="E-mail" required>
        </div>

        <!-- INPUT SENHA + BOTÃO MOSTRAR -->
...
<!-- SCRIPT BARRA DE FORÇA + MOSTRAR/OCULTAR -->
<script>
